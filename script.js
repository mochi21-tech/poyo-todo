...
const ACCESSORY_CONFIG = [
  ...
  { id: "acc4",   label: "きつね",         requiredCount: 3, src: "asset/asset4.svg" },
  { id: "acc5",   label: "コアラ",         requiredCount: 4, src: "asset/asset5.svg" },
  { id: "acc6",   label: "ヤギ",           requiredCount: 5, src: "asset/asset6.svg" },
  { id: "acc7",   label: "くま",           requiredCount: 21, src: "asset/asset7.svg" },
  { id: "acc17",  label: "星",             requiredCount: 24, src: "asset/asset17.svg" },
  { id: "acc8",   label: "いぬ",           requiredCount: 27, src: "asset/asset8.svg" },
  { id: "acc9",   label: "ライオン",       requiredCount: 30, src: "asset/asset9.svg" },
  { id: "acc10",  label: "ねずみ",         requiredCount: 33, src: "asset/asset10.svg" },
  { id: "acc11",  label: "キリン",         requiredCount: 36, src: "asset/asset11.svg" },
  { id: "acc1",   label: "うさぎ",         requiredCount: 39, src: "asset/asset1.svg" },
  { id: "acc12",  label: "シカ",           requiredCount: 42, src: "asset/asset12.svg" },
  { id: "acc13",  label: "トラ",           requiredCount: 45, src: "asset/asset13.svg" },
  { id: "acc14",  label: "うし",           requiredCount: 48, src: "asset/asset14.svg" },
  { id: "acc15",  label: "クラウン",       requiredCount: 51, src: "asset/asset15.svg" },
];
